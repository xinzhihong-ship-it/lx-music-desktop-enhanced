const modules = {
  ...
  winMain: {
    ...
    mpv_init: 'mpv_init',
    mpv_loadUrl: 'mpv_loadUrl',
    mpv_play: 'mpv_play',
    mpv_pause: 'mpv_pause',
    mpv_stop: 'mpv_stop',
    mpv_seek: 'mpv_seek',
    mpv_setVolume: 'mpv_setVolume',
    mpv_getPosition: 'mpv_getPosition',
    mpv_getDuration: 'mpv_getDuration',
    mpv_getPaused: 'mpv_getPaused',
    mpv_destroy: 'mpv_destroy',
    mpv_started: 'mpv_started',
    mpv_loaded: 'mpv_loaded',
    mpv_playing: 'mpv_playing',
    mpv_pause_event: 'mpv_pause_event',
    mpv_stopped: 'mpv_stopped',
    mpv_ended: 'mpv_ended',
    mpv_error: 'mpv_error',
    mpv_timeUpdate: 'mpv_timeUpdate',
    mpv_duration: 'mpv_duration',
    mpv_listAudioDevices: 'mpv_listAudioDevices',
