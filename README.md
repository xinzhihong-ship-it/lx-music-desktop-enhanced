...
- **高音质与稳定播放**
  ...
  - 播放失败时支持刷新链接、切换自定义音源、切换平台、降低音质、播放下一曲；可设置重试次数并拖动调整恢复顺序，也可保留仅换平台、仅降质或直接下一曲。
  - 音质选择改为整齐的响应式网格，播放栏同步显示实际播放音质与播放引擎。
  - 过滤网易云歌单中的空标题占位曲目，避免空关键词换源时错误跳转到热门歌曲。
...
- Linux
- macOS
- Windows 10 及以上（Win7 兼容包仅作为实验性测试产物）
